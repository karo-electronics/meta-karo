...
SRC_URI = " \
    git://git.trustedfirmware.org/TF-M/trusted-firmware-m.git;protocol=http;nobranch=1;name=tfm;destsuffix=git/tfm \
...
FILESEXTRAPATHS:prepend := "${THISDIR}/${PN}/patches:${THISDIR}/${PN}/patches/tf-m-tests:"
